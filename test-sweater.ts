...
async function main() {
  console.log('🧥 Ghost Mannequin Pipeline - Sweater Test');
  console.log('============================================================');
  ...
  // Load sweater image
  const testImagePath = join(process.cwd(), 'Input', 'eat trui.jpg');
  const imageBuffer = readFileSync(testImagePath);
  const imageBase64 = `data:image/jpeg;base64,${imageBuffer.toString('base64')}`;

  console.log(`📸 Processing: eat trui.jpg`);
