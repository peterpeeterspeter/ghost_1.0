...
async function main() {
  console.log('👕 Ghost Mannequin Pipeline - Singlet Test');
  console.log('============================================================');
  ...
  // Load singlet image
  const testImagePath = join(process.cwd(), 'Input', 'singlet Detail.jpg');
  const imageBuffer = readFileSync(testImagePath);
  const imageBase64 = `data:image/jpeg;base64,${imageBuffer.toString('base64')}`;

  console.log(`📸 Processing: singlet Detail.jpg`);
